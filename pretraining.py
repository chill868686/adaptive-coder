...
model_saved_path = './bert4keras/saved_model/bert_model.ckpt'
#corpus_paths = [
#    'gs://xxxx/bert4keras/corpus/corpus.%s.tfrecord' % i for i in range(10)
#]
corpus_paths = [
    './bert4keras/corpus/corpus.tfrecord'
]
...
#checkpoint_path = '/home/spaces_ac_cn/basemodel/bert_model.ckpt'  # 如果从零训练，就设为None
